...
public class Student {
	...
	public static Optional<Student> create(final String firstName, final String lastName, final int indexNumber) {
		...
		try {
			return Optional.of(QueryExecutor.createAndObtainId(insertSql)).flatMap(Student::findById);
	...
	public static Optional<Student> findByIndexNumber(final int indexNumber) {
		...
		try {
			ResultSet student = QueryExecutor.read(findByIndexNumberSql);

			return Optional.of(new Student(student.getInt("id"), student.getString("first_name"),
	...
	public static Optional<Student> findById(final int id) {
		...
		try {
	        ...
	        return Optional.of(new Student(rs.getInt("id"), rs.getString("first_name"),

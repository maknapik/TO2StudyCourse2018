...
import pl.edu.agh.iisg.to.javafx.cw3.command.DeleteTransactionCommand;
...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		DeleteTransactionCommand deleteTransactionCommand = new DeleteTransactionCommand(transactionsTable.getSelectionModel().getSelectedItems(), data);
		commandRegistry.executeCommand(deleteTransactionCommand);
	}
